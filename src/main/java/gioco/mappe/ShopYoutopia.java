...
/**
 * negozio di un commerciante, permette di acquistare item
 */
public class ShopYoutopia extends BaseScreen{
    ...
    public void initialize() {
        ...
        tma = new TilemapActor("assets/NegozioYoutopia.tmx", mainStage, camera);
        tma.setScale(4);
